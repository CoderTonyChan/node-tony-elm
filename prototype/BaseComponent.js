...
import formidable from 'formidable' // https://www.npmjs.com/package/formidablenpm i -S formidable
import path from 'path'
import fs from 'fs'
import qiniu from 'qiniu' // https://www.npmjs.com/package/qiniu (七牛云存储 Node.js SDK 使用指南)
import gm from 'gm' // https://www.npmjs.com/package/gm 
...
export default class BaseComponent {
	constructor(){
		...
		this.uploadImg = this.uploadImg.bind(this) // 方法绑定
		this.qiniu = this.qiniu.bind(this) // 方法绑定
	}
